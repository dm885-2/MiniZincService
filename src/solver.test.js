...
//     it("should return a optimal solution", () => new Solver(false, false, false, false, false, false, false, false,false, false, (data) => {
//         expect(data.find(d => d.optimal)).toBeTruthy();
//     }));

//     it("should return 7 solutions", () => new Solver(false, false, false, false, false, false, false, false,false, false, (data) => {
//         expect(data.length).toBe(7);
//     }));

//     it("should call the exec function", () => new Solver(false, false, false, false, false, false, false, false,false, false, (data) => {
